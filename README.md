...
- POJO로 구현하는 방법 : ex) PlatformTransactionManager 처럼 transactionManager가 수행해야할 필수기능들을 interface로 구현해놓고 , 실제 device별로 interface를 상속받은 manager를 구현하는 방법을 통해서 POJO PSA를 구현할수있다.
